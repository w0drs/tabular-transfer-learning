...
- **Признаки:** 17 (возраст, профессия, баланс, кампания и др.)
...
> Transfer Learning между Adult и Bank не даст значимого улучшения.
...
| Модель | AP | F1 | Время (сек) |
| :--- | :--- | :--- | :--- |
| CatBoost с параметрами | **0.5671** | 0.4788 | 1.59 |
...
MLP дал AP = 0.5155, что всего на 9% ниже CatBoost, но учится **в 30 раз дольше**. На малых данных классические алгоритмы остаются лучше.
...
2. Классические алгоритмы остаются лучшими для малых табличных данных (AP = 0.5671, скорость 1.6 сек).
